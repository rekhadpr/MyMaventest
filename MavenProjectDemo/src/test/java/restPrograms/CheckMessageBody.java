...
//	@Test(priority = 2)
	...
	//    Assert.assertEquals(statusLine, "HTTP/1.1 200 OK", "Correct status code returned");
	    sftassert.assertEquals(statusLine, "HTTP/1.1 200 OK", "Correct status code returned");
...
//	@Test(priority = 3)
	public void WeatherMessageBody()
	{
		...
		Assert.assertEquals(bodyAsString.toLowerCase().contains("Byron") , true , "check if Byron present");
	}
